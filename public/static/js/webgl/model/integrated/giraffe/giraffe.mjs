...
export class Giraffe {
    ...
    buildSkeleton() {
        ...
        const headShape = [0.6/scale, 0.4/scale, 0.8/scale];
        const legShape = [0.2/scale, 0.6/scale, 0.2/scale];
        const feetShape = [0.2/scale, 0.6/scale, 0.2/scale];
        ...
        const kScaleFeet = [feetShape[0]/cubeSize, feetShape[1]/cubeSize, feetShape[2]/cubeSize]
        ...
        const translateFrontFeet = {
            'left': [translateFrontLeg['left'][0], translateFrontLeg['left'][1] - legShape[1], translateFrontLeg['left'][2]],
            'right': [translateFrontLeg['right'][0], translateFrontLeg['right'][1] - legShape[1], translateFrontLeg['right'][2]]
        }
        const translateBackFeet = {
            'left': [translateBackLeg['left'][0], translateBackLeg['left'][1] - legShape[1], translateBackLeg['left'][2]],
            'right': [translateBackLeg['right'][0], translateBackLeg['right'][1] - legShape[1], translateBackLeg['right'][2]]
        }
        ...
        const feet = scaleBlock(defCube, kScaleFeet[0], kScaleFeet[1]+0.1, kScaleFeet[2])
        ...
        this.centers = {
            ...
            'feet-front-left': translateFrontFeet['left'],
            'feet-front-right': translateFrontFeet['right'],
            'feet-back-left': translateBackFeet['left'],
            'feet-back-right': translateBackFeet['right'],
        }
        ...
        this.skeletons = {
            ...
            'feet-front-left': translateBlock(feet, this.centers['feet-front-left'][0], this.centers['feet-front-left'][1], this.centers['feet-front-left'][2]),
            'feet-front-right': translateBlock(feet, this.centers['feet-front-right'][0], this.centers['feet-front-right'][1], this.centers['feet-front-right'][2]),
            'feet-back-left': translateBlock(feet, this.centers['feet-back-left'][0], this.centers['feet-back-left'][1], this.centers['feet-back-left'][2]),
            'feet-back-right': translateBlock(feet, this.centers['feet-back-right'][0], this.centers['feet-back-right'][1], this.centers['feet-back-right'][2]),
        }
        ...
        this.colors = {
            ...
            'feet-front-left': new Float32Array(changeBlockColor(this.skeletons['feet-front-left'], 1, 1, 0)),
            'feet-front-right': new Float32Array(changeBlockColor(this.skeletons['feet-front-right'], 1, 0, 1)),
            'feet-back-left': new Float32Array(changeBlockColor(this.skeletons['feet-back-left'], 0, 1, 1)),
            'feet-back-right': new Float32Array(changeBlockColor(this.skeletons['feet-back-right'], 0.5, 0.5, 0.5)),
        };
        ...
        this.jointPoints = {
            ...
            'leg-front-left': [this.centers['leg-front-left'][0], this.centers['leg-front-left'][1] + legShape[1], this.centers['leg-front-left'][2]],
            'leg-front-right': [this.centers['leg-front-right'][0], this.centers['leg-front-right'][1] + legShape[1], this.centers['leg-front-right'][2]],
            'leg-back-left': [this.centers['leg-back-left'][0], this.centers['leg-back-left'][1] + legShape[1], this.centers['leg-back-left'][2]],
            'leg-back-right': [this.centers['leg-back-right'][0], this.centers['leg-back-right'][1] + legShape[1], this.centers['leg-back-right'][2]],
            'feet-front-left': [this.centers['feet-front-left'][0], this.centers['feet-front-left'][1] + feetShape[1], this.centers['feet-front-left'][2]],
            'feet-front-right': [this.centers['feet-front-right'][0], this.centers['feet-front-right'][1] + feetShape[1], this.centers['feet-front-right'][2]],
            'feet-back-left': [this.centers['feet-back-left'][0], this.centers['feet-back-left'][1] + feetShape[1], this.centers['feet-back-left'][2]],
            'feet-back-right': [this.centers['feet-back-right'][0], this.centers['feet-back-right'][1] + feetShape[1], this.centers['feet-back-right'][2]],
        }
        ...
        this.textures = {
            ...
            'feet-front-left': texture,
            'feet-front-right': texture,
            'feet-back-left': texture,
            'feet-back-right': texture,
        }
        ...
        this.textureCoords = {
            ...
            'feet-front-left': cubeTextureCoordinates,
            'feet-front-right': cubeTextureCoordinates,
            'feet-back-left': cubeTextureCoordinates,
            'feet-back-right': cubeTextureCoordinates,
        }
        ...
        this.normals = {
            ...
            'feet-front-left': getNormalCube(this.skeletons['feet-front-left']),
            'feet-front-right': getNormalCube(this.skeletons['feet-front-right']),
            'feet-back-left': getNormalCube(this.skeletons['feet-back-left']),
            'feet-back-right': getNormalCube(this.skeletons['feet-back-right']),
        }
        ...
        this.tangents = {
            ...
            'feet-front-left': getTangentCube(this.skeletons['feet-front-left']),
            'feet-front-right': getTangentCube(this.skeletons['feet-front-right']),
            'feet-back-left': getTangentCube(this.skeletons['feet-back-left']),
            'feet-back-right': getTangentCube(this.skeletons['feet-back-right']),
        }
        ...
        this.bitangents = {
            ...
            'feet-front-left': getBitangentCube(this.skeletons['feet-front-left']),
            'feet-front-right': getBitangentCube(this.skeletons['feet-front-right']),
            'feet-back-left': getBitangentCube(this.skeletons['feet-back-left']),
            'feet-back-right': getBitangentCube(this.skeletons['feet-back-right']),
        }
        ...
        this.inRotation = {
            ...
            'feet-front-left': {'x': 0, 'y': 0, 'z': 0},
            'feet-front-right': {'x': 0, 'y': 0, 'z': 0},
            'feet-back-left': {'x': 0, 'y': 0, 'z': 0},
            'feet-back-right': {'x': 0, 'y': 0, 'z': 0},
        }
    ...
    createTree() {
        ...
        this.root.left.right.left = skeletonNodes['feet-front-left'] 
        this.root.left.right.right = skeletonNodes['leg-front-right'] 
        this.root.left.right.right.left = skeletonNodes['feet-front-right'] 
        this.root.left.right.right.right = skeletonNodes['leg-back-left'] 
        this.root.left.right.right.right.left = skeletonNodes['feet-back-left'] 
        this.root.left.right.right.right.right = skeletonNodes['leg-back-right'] 
        this.root.left.right.right.right.right.left = skeletonNodes['feet-back-right'] 
    }
    ...
    updateTransform(node=this.root) {
        ...
        if (node.left) {
            ...
            while (siblingNode) {
                ...
                if (siblingNode.left) {
                    this.updateTransform(siblingNode);
                }
    ...
    distributeRotation(val) {
        ...
        this.inRotation['feet-front-left']['x'] = -val/2
        this.inRotation['feet-front-right']['x'] = val/2
        this.inRotation['feet-back-left']['x'] = -val/2
        this.inRotation['feet-back-right']['x'] = val/2
    }
    ...
    updateAnimation() {
        ...
        this.root.left.right.left.baseTransform = rotateMat(this.inRotation['feet-front-left']['x'], 0, 0, this.root.left.right.left.jointPoint[0], this.root.left.right.left.jointPoint[1], this.root.left.right.left.jointPoint[2])
        ...
        this.root.left.right.right.left.baseTransform = rotateMat(this.inRotation['feet-front-right']['x'], 0, 0, this.root.left.right.right.left.jointPoint[0], this.root.left.right.right.left.jointPoint[1], this.root.left.right.right.left.jointPoint[2])
        ...
        this.root.left.right.right.right.left.baseTransform = rotateMat(this.inRotation['feet-back-left']['x'], 0, 0, this.root.left.right.right.right.left.jointPoint[0], this.root.left.right.right.right.left.jointPoint[1], this.root.left.right.right.right.left.jointPoint[2])
        ...
        this.root.left.right.right.right.right.left.baseTransform = rotateMat(this.inRotation['leg-back-right']['x'], 0, 0, this.root.left.right.right.right.right.left.jointPoint[0], this.root.left.right.right.right.right.left.jointPoint[1], this.root.left.right.right.right.right.left.jointPoint[2])
    }
}